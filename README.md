...
A lot changed but im too lazy to update this readme file just try it and see. dont use auto replay spammer u will get banned. REPORT THE BUGS, DUMP FILES, CRASHES TO alperen1912 ON DISCORD IF YOU WANT THIS SHIT TO GET BETTER. I BEG YOU.
